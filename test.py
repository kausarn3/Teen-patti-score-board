...
class QuadrantWindow(QWidget):
    def __init__(self):
        ...
        self.playArea()
        #self.grid_layout.addWidget(form_widget, 0, 0)  # Row 0, Column 0

        # Second Quadrant: Label
        label1 = QLabel("This is the second quadrant")
        label1.setAlignment(Qt.AlignCenter)
        label1.setStyleSheet("font-size: 18px; background-color: #f0f0f0; padding: 20px; border: 1px solid #ccc; border-radius: 10px;")
